...
#define EXPR_BUFSIZ     100000         /* 数式の一行の最大の長さ           */
#define LIMIT_LINE      1000          /* formula maximum length in FORT77 */ 
...
#define MAX_TERM_VARS      100   /* quadrature,element等でterm_convertで
				   必要になる変数名バッファの大きさ     */
/********************************/
...
#define Linux_CONTOUR_LIB          "-L$(HOME)/lib -lfeelG"    /* change to $(HOME) */
