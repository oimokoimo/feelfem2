 ...
 *            ~      ~       ~        ~
 *      File:   elem_fort77_main_CG_nonlinear.c
 *      Date:   1993/07/12
 *   
...
void elem_fort77_main_CG_nonlinear( no , solve_element_ptr )
     ...
     SolveElement *solve_element_ptr;   /* SolveElement 構造体  */
{
    ...
    switch(dimension) {
      case 1: 
	F77("(x,ielem,matno,nelem,np,A,JA,NNN,MJ,JDP,B,IPD");
	break;
      case 2:
	F77("(x,y,ielem,matno,nelem,np,A,JA,NNN,MJ,JDP,B,IPD");
	break;
      case 3:
	F77("(x,y,z,ielem,matno,nelem,np,A,JA,NNN,MJ,JDP,B,IPD");
	break;
    }
