...
vsvw_(xmin,ymin,zmin,xmax,ymax,zmax,xref,yref,zref,id)
...
vscp_( xmin , ymin , zmin , xmax , ymax , zmax , id )
...
vudt_(px1,py1,pz1,px2,py2,pz2,d)
...
vuip_(px1,py1,pz1,px2,py2,pz2,v)
...
vetc_(x,y,z,s,n,nf,cid,cv,nc,id)
double	*x,*y,*z,*s,*cv;
int	*n,*nf,*cid,*nc,*id;
{
	int		i;
...
veqc_(x,y,z,s,m,n,nf,cid,cv,nc,id)
double	*x,*y,*z,*s,*cv;
...
vecb2_(nx,ny,n,value,fg,mid,cid,id)
int     *nx,*ny;
double  *value;
int     *n,*fg,*mid,*cid,*id;
{
...
vevt_(x,y,z,u,v,w,np,sz,vm,nf,nc,cv,cid,id)
...
void    vepa_(xmin,xmax,ymin,ymax,nx,ny,npy,cid,id)
...
void    vepl_(px,py,np,xmin,xmax,ymin,ymax,cid,id)
double  *px,*py;
double  *xmin,*xmax,*ymin,*ymax;
int     *np;
int     *cid,*id;
...
void    vepm_(px,py,np,xmin,xmax,ymin,ymax,mid,cid,id)
double  *px,*py;
double  *xmin,*xmax,*ymin,*ymax;
int     *np;
int     *mid,*cid,*id;
...
void    vepx_(xmin,xmax,ymin,ymax,nx,ny,fg)
double  *xmin,*xmax,*ymin,*ymax;
int     *nx,*ny,*fg;
{
...
/* 2026/5/5 memory alloc problem */
int vrsd_(id)
int *id;
{
    return ViewResetDraw(*id);
}
