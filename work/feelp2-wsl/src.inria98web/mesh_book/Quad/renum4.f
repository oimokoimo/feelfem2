c**********************************************************************
c
c     renumber.f    programed by nsis matumoto  1993.06.08
c     renumbering   for 4 node square element
c 
c**********************************************************************
      subroutine renum4( node,nelm,mtj,px,py,ifix,jnt,ktj,kte )
c
...
c
      ...
      dimension ip( nomax,9 ),jt( nomax*nnd ),memjt( nomax*kcm )
