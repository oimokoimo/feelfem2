c**********************************************************************
c
c     renumbering        renumber.f
c 
c**********************************************************************
      subroutine renumber( node,nelm,mtj,px,py,jnt,ktj )
c
      implicit real*8( a-h,o-z )
      parameter ( nomax = 10000 )
c      parameter ( nomax = 20000*2 )
      parameter ( kcm = 40 )
c
      dimension mtj( 2 * ktj + 1,3 ),jnt( ktj )
      dimension px( ktj + 3 ),py( ktj + 3 )
      dimension jmem( nomax ),xj( nomax ),yj( nomax )
      dimension ip( nomax,3 ),jt( nomax*3 ),memjt( nomax*kcm )
