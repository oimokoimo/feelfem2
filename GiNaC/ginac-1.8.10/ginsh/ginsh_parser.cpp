...
{
       0,   144,   144,   145,   148,   149,   158,   166,   174,   188,
     ...
     293,   294,   297,   298,   301,   302,   305,   306
};
#endif
...
#line 1323 "ginsh_parser.cpp"
    break;

  case 6: /* line: exp ':'  */
#line 158 "ginsh_parser.ypp"
                  {
		try {
			push(yyvsp[-1]);
		} catch (exception &e) {
...
#line 1336 "ginsh_parser.cpp"
    break;

  case 7: /* line: T_PRINT '(' exp ')' ';'  */
#line 166 "ginsh_parser.ypp"
                                  {
		try {
...
#line 1349 "ginsh_parser.cpp"
    break;

  case 8: /* line: T_IPRINT '(' exp ')' ';'  */
#line 174 "ginsh_parser.ypp"
                                   {
		try {
			ex e = yyvsp[-2];
...
#line 1368 "ginsh_parser.cpp"
    break;

  case 9: /* line: T_PRINTLATEX '(' exp ')' ';'  */
#line 188 "ginsh_parser.ypp"
                                       {
		try {
...
#line 1381 "ginsh_parser.cpp"
    break;

  case 10: /* line: T_PRINTCSRC '(' exp ')' ';'  */
#line 196 "ginsh_parser.ypp"
                                      {
		try {
...
#line 1394 "ginsh_parser.cpp"
    break;

  case 11: /* line: '?' T_SYMBOL  */
#line 204 "ginsh_parser.ypp"
                                {print_help(ex_to<symbol>(yyvsp[0]).get_name());}
#line 1400 "ginsh_parser.cpp"
    break;

  case 12: /* line: '?' T_TIME  */
#line 205 "ginsh_parser.ypp"
                                {print_help("time");}
...
#line 212 "ginsh_parser.ypp"
		...
		cout << "this program.  If not, see <https://www.gnu.org/licenses/>.\n";
	}
#line 1459 "ginsh_parser.cpp"
    break;

  case 20: /* line: T_XYZZY  */
#line 224 "ginsh_parser.ypp"
                                {cout << "Nothing happens.\n";}
#line 1465 "ginsh_parser.cpp"
    break;

  case 21: /* line: T_INVENTORY  */
#line 225 "ginsh_parser.ypp"
                                {cout << "You're not carrying anything.\n";}
#line 1471 "ginsh_parser.cpp"
    break;

  case 22: /* line: T_LOOK  */
#line 226 "ginsh_parser.ypp"
                                {cout << "You're in a twisty little maze of passages, all alike.\n";}
#line 1477 "ginsh_parser.cpp"
    break;
...
#line 1487 "ginsh_parser.cpp"
    break;

  case 24: /* line: T_REAL_SYMBOLS  */
#line 232 "ginsh_parser.ypp"
                         { symboltype = domain::real; }
#line 1493 "ginsh_parser.cpp"
    break;

  case 25: /* line: T_COMPLEX_SYMBOLS  */
#line 233 "ginsh_parser.ypp"
                            { symboltype = domain::complex; }
#line 1499 "ginsh_parser.cpp"
    break;

  case 26: /* $@1: %empty  */
#line 234 "ginsh_parser.ypp"
                 { START_TIMER }
#line 1505 "ginsh_parser.cpp"
    break;

  case 27: /* line: T_TIME $@1 '(' exp ')'  */
#line 234 "ginsh_parser.ypp"
                                             { STOP_TIMER PRINT_TIME_USED }
#line 1511 "ginsh_parser.cpp"
    break;

  case 28: /* line: error ';'  */
#line 235 "ginsh_parser.ypp"
                                {yyclearin; yyerrok;}
#line 1517 "ginsh_parser.cpp"
    break;

  case 29: /* line: error ':'  */
#line 236 "ginsh_parser.ypp"
                                {yyclearin; yyerrok;}
#line 1523 "ginsh_parser.cpp"
    break;

  case 30: /* exp: T_NUMBER  */
#line 239 "ginsh_parser.ypp"
                                {yyval = yyvsp[0];}
#line 1529 "ginsh_parser.cpp"
    break;

  case 31: /* exp: T_SYMBOL  */
#line 240 "ginsh_parser.ypp"
                                {
...
#line 1541 "ginsh_parser.cpp"
    break;

  case 32: /* exp: '\'' T_SYMBOL '\''  */
#line 247 "ginsh_parser.ypp"
                                {yyval = yyvsp[-1];}
#line 1547 "ginsh_parser.cpp"
    break;

  case 33: /* exp: T_LITERAL  */
#line 248 "ginsh_parser.ypp"
                                {yyval = yyvsp[0];}
#line 1553 "ginsh_parser.cpp"
    break;

  case 34: /* exp: T_DIGITS  */
#line 249 "ginsh_parser.ypp"
                                {yyval = yyvsp[0];}
#line 1559 "ginsh_parser.cpp"
    break;

  case 35: /* exp: T_QUOTE  */
#line 250 "ginsh_parser.ypp"
                                {yyval = exstack[0];}
#line 1565 "ginsh_parser.cpp"
    break;

  case 36: /* exp: T_QUOTE2  */
#line 251 "ginsh_parser.ypp"
                                {yyval = exstack[1];}
#line 1571 "ginsh_parser.cpp"
    break;

  case 37: /* exp: T_QUOTE3  */
#line 252 "ginsh_parser.ypp"
                                {yyval = exstack[2];}
#line 1577 "ginsh_parser.cpp"
    break;
...
#line 261 "ginsh_parser.ypp"
                                {yyval = yyvsp[0]; Digits = ex_to<numeric>(yyvsp[0]).to_int();}
#line 1596 "ginsh_parser.cpp"
    break;

  case 40: /* exp: T_SYMBOL '=' exp  */
#line 262 "ginsh_parser.ypp"
                                {
		yyval = yyvsp[0];
		const exmap m{{yyvsp[-2], yyvsp[0]}};
		for (auto & s : assigned_symbol_table) {
			s.second = s.second.subs(m);
		}
		assigned_symbol_table[yyvsp[-2]] = yyvsp[0];
	}
...
#line 1687 "ginsh_parser.cpp"
  ...
  case 54: /* exp: exp '!'  */
#line 283 "ginsh_parser.ypp"
                                {yyval = factorial(yyvsp[-1]);}
#line 1693 "ginsh_parser.cpp"
    break;

  case 55: /* exp: '(' exp ')'  */
#line 284 "ginsh_parser.ypp"
                                {yyval = yyvsp[-1];}
...
#line 1759 "ginsh_parser.cpp"
  ...
  case 66: /* row: exp  */
#line 305 "ginsh_parser.ypp"
                                {yyval = lst{yyvsp[0]};}
#line 1765 "ginsh_parser.cpp"
    break;

  case 67: /* row: row ',' exp  */
#line 306 "ginsh_parser.ypp"
                                {lst l(ex_to<lst>(yyvsp[-2])); yyval = l.append(yyvsp[0]);}
#line 1771 "ginsh_parser.cpp"
    break;


#line 1775 "ginsh_parser.cpp"
...
static ex f_Gt(const exprseq &e)
{
	CHECK_ARG(0, lst, Gt);
	return GiNaC::Gt(e[0], e[1], e[2]);
}
...
static ex f_Gt_evaluate(const exprseq &e) {
	CHECK_ARG(1, lst, Gt_evaluate);
	if(is_a<lst>(e[0]))
		return Gt::lst_evaluate(ex_to<lst>(e[0]), ex_to<lst>(e[1]));
	else
		return Gt::ex_evaluate(e[0], ex_to<lst>(e[1]));
}
static ex f_Gt_enableTauToFundamental(const exprseq &e) {
	CHECK_ARG(0, numeric, Gt_enableTauToFundamental);
	Gt::enable_tauToFundamental = !ex_to<numeric>(e[0]).is_zero();
	cout << "Gt::enable_tauToFundamental set to " << Gt::enable_tauToFundamental << endl;
	return numeric(0);
}
static ex f_Gt_setCutThresholds(const exprseq &e) {
	CHECK_ARG(0, numeric, Gt_setCutThresholds);
	CHECK_ARG(1, numeric, Gt_setCutThresholds);
	const numeric n_real = ex_to<numeric>(e[0]), n_imag = ex_to<numeric>(e[1]);
	if(!(n_real.is_real() && 0 < n_real && n_real < 0.5 && n_imag.is_real() && 0 < n_imag && n_imag < 0.5))
		throw std::runtime_error("Invalid arguments passed to Gt_setCutThresholds");
	Gt::cutIntegrationPath_threshold_real = n_real.to_double();
	Gt::cutIntegrationPath_threshold_imag = n_imag.to_double();
	cout << "Gt::cutIntegrationPath_threshold_real set to " << Gt::cutIntegrationPath_threshold_real << endl;
	cout << "Gt::cutIntegrationPath_threshold_imag set to " << Gt::cutIntegrationPath_threshold_imag << endl;
	return numeric(0);
}
static ex f_Gt_prepare(const exprseq &e) {
	CHECK_ARG(1, lst, f_Gt_prepare);
	return Gt::ex_prepare(e[0], ex_to<lst>(e[1]));
}
static ex f_Gt_zisToFundamental(const exprseq &e) {
	CHECK_ARG(1, lst, f_Gt_zisToFundamental);
	return Gt::ex_zisToFundamental(e[0], ex_to<lst>(e[1]));
}
static ex f_Gt_regularise(const exprseq &e) {
	CHECK_ARG(1, lst, f_Gt_regularise);
	return Gt::ex_regularise(e[0], ex_to<lst>(e[1]));
}
static ex f_Gt_tauToFundamental(const exprseq &e) {
	CHECK_ARG(1, lst, f_Gt_tauToFundamental);
	return Gt::ex_tauToFundamental(e[0], ex_to<lst>(e[1]));
}
static ex f_Gt_cutIntegrationPath(const exprseq &e) {
	CHECK_ARG(1, lst, f_Gt_cutIntegrationPath);
	return Gt::ex_cutIntegrationPath(e[0], ex_to<lst>(e[1]));
}
static ex f_Gt_qExpand(const exprseq &e) {
	CHECK_ARG(1, lst, f_Gt_qExpand);
	return Gt::ex_qExpand(e[0], ex_to<lst>(e[1]));
}
...
static const fcn_init builtin_fcns[] = {
	...
	{"subs", f_subs2, 2},
	{"subs", f_subs3, 3},
	{"Gt_evaluate", f_Gt_evaluate, 2},
	{"Gt_enableTauToFundamental", f_Gt_enableTauToFundamental, 1},
	{"Gt_setCutThresholds", f_Gt_setCutThresholds, 2},
	{"Gt_prepare", f_Gt_prepare, 2},
	{"Gt_zisToFundamental", f_Gt_zisToFundamental, 2},
	{"Gt_regularise", f_Gt_regularise, 2},
	{"Gt_tauToFundamental", f_Gt_tauToFundamental, 2},
	{"Gt_cutIntegrationPath", f_Gt_cutIntegrationPath, 2},
	{"Gt_qExpand", f_Gt_qExpand, 2},
	{"tcoeff", f_tcoeff, 2},
...
static const fcn_help_init builtin_help[] = {
	...
	{"Gt", "elliptic multiple polylogarithm (integral representation)"},
	{"Li2", "dilogarithm"},
	{"Li3", "trilogarithm"},
...
void greeting(void)
{
    ...
    cout << "  __,  _______  Copyright (C) 1999-2026 Johannes Gutenberg University Mainz,\n"
