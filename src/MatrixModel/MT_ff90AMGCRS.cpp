...
MT_ff90AMGCRS::MT_ff90AMGCRS() 
{
  return;   // do nothing now
}

MT_ff90AMGCRS::~MT_ff90AMGCRS() = default;
...
void MT_ff90AMGCRS::GenerateCoSolveElemGenerator (Solve *solvePtr)
{
  ElemGeneratorTemplate<MT_ff90AMGCRS> *ptrEG =
    new ElemGeneratorTemplate<MT_ff90AMGCRS>();
...
void MT_ff90AMGCRS::F90useSolveMT( void )
{
...
//  General routine
////////////////////////////////////////////////////
void MT_ff90AMGCRS::pushMatrixArgumentsCalled()
{
  pushSource("valmat,vfg,indrow,iptrcol,neq");
  return;
}

void MT_ff90AMGCRS::writeMatrixDeclarations()
{
...
void MT_ff90AMGCRS::DoSolveVariableDefinitionsMT()
{
...
void MT_ff90AMGCRS::DoSolveInitializerMT(Solve *solvePtr)
{
  // do nothing for AMGCRS
  return;
}

void MT_ff90AMGCRS::pushMatrixArgumentsAllocated(void)
{
...
void MT_ff90AMGCRS::DoSolveMatrixAllocate( Solve *)
{
...
////////////////////////////////////////////////////
void MT_ff90AMGCRS::DoSolveCallAssembleRoutine( Solve *solvePtr)
{
...
////////////////////////////////////////////////////
void MT_ff90AMGCRS::DoSolveCallLinearNeumannData( Solve *solvePtr)
{
...
////////////////////////////////////////////////////
void MT_ff90AMGCRS::DoSolveCallLinearDirichletData( Solve *solvePtr)
{
...
void MT_ff90AMGCRS::DoSolveCallEdevRoutine( Solve *solvePtr)
{
...
void MT_ff90AMGCRS::DoSolveFreeMemoryMT()
{
...
void MT_ff90AMGCRS::DoSolveMakeUpdateInformationMT()
{
