 ...
 *
 *  Filename : feelfem90smpi_ecal.cpp
...
const char *PM_feelfem90smpi::GetEcalRoutineName( int solveNo, int elemNo) 
{
...
void PM_feelfem90smpi::pushEcalRoutineName(SolveElement *sePtr)
{
  pushSource("ecal");
...
void PM_feelfem90smpi::pushEcalArgumentLstInElem(SolveElement *sePtr,
...
void PM_feelfem90smpi::pushEcalArgumentLstInEcal(SolveElement *sePtr,
					     orderedPtrList<Variable *>vPtrLst)
{
  listIterator <Variable *>itrV(vPtrLst);
...
// dependent on TermConvert
void PM_feelfem90smpi::EcalArgumentVariableDeclarationLst(SolveElement *sePtr,
						      orderedPtrList
						      <Variable *>&vPtrLst)
{
  listIterator <Variable *>itrV(vPtrLst);
...
void PM_feelfem90smpi::DoEcalRoutineHeader(SolveElement *sePtr)
{
...
void PM_feelfem90smpi::doEcalArgumentSequence(SolveElement *sePtr)
{
...
void PM_feelfem90smpi::doEcalDeclareArgumentVariables(SolveElement *sePtr)
{
  int ielemNodes = sePtr->GetIelemNodes();
...
void PM_feelfem90smpi::DoEcalParameters(SolveElement *sePtr)
{
...
void PM_feelfem90smpi::DoEcalVariableDefinitions(SolveElement *sePtr )
{
...
void PM_feelfem90smpi::EcalElementMatRHSVariableDeclaration(int solveNo,int elemNo)
{
  pushReal8sc();
  flushSource("ea,eb");
  return;
...
void PM_feelfem90smpi::EcalElementMatRHSCommon(int solveNo, int elemNo)
{
...
void PM_feelfem90smpi::EcalQuadCommon(SolveElement *sePtr,
				  DiscretizedComponent *dcPtr,
...
void PM_feelfem90smpi::DoEcalReturnSequence(SolveElement *sePtr)
{
...
void PM_feelfem90smpi::DoEcalElementMatInitialize(SolveElement *sePtr)
{
...
void PM_feelfem90smpi::DoEcalQuadLoopStart(int quadNo, SolveElement *sePtr)
{
  comment();
...
void PM_feelfem90smpi::DoEcalQuadLoopEnd(int quadNo, SolveElement *sePtr)
{
  com();
...
void PM_feelfem90smpi::DoEcalCalcJacobian(int quadNo, SolveElement *sePtr)
{
...
void PM_feelfem90smpi::pushEcalJacobiSub(int quadNo,int freedom,int *ndPattern,
...
void PM_feelfem90smpi::pushEcalCoordSub(int quadNo, Element *ePtr,
...
void PM_feelfem90smpi::DoEcalSetValAtGaussP(int quadNo, SolveElement *sePtr)
{
...
void PM_feelfem90smpi::DoEcalCalcElementMatRHS(int quadNo, SolveElement *sePtr)
{
  comment();
...
void PM_feelfem90smpi::pushEcalDiffSub_1st(int quadNo,Element *ePtr,int dim,
				       int no,int diffType              )
{
  pushSource("  q");
