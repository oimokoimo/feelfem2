 ...
 *
 *  Filename : feelfem90smpi_dirichlet.cpp
...
void PM_feelfem90smpi::pushDirichletRoutineName(int solveNo, int dcondNo)
{
  char buf[BUFSIZ];
...
void PM_feelfem90smpi::F90useDirichletPM()
{
  F90useFEMDataType();
  F90useAlways();
...
const char *PM_feelfem90smpi::GetDirichletRoutineName(int solveNo, int dcondNo)
{
...
void PM_feelfem90smpi::DoDirichletArgumentVariableDefinitionsPM(Dirichlet *dPtr)
{
...
void PM_feelfem90smpi::doDirichletAutoVariableDefinitionsPM(Dirichlet *dPtr)
{
...
void PM_feelfem90smpi::DoDirichletReturnSequencePM(Dirichlet *dPtr)
{
  com();
...
void PM_feelfem90smpi::doSetDirichletValue(Dirichlet *dPtr)
{
  pushSource( "  u = ");
...
void PM_feelfem90smpi::DoDirichletInitializer(Dirichlet *dPtr)
{
  com();
...
void PM_feelfem90smpi::DoDirichletLoopStart(Dirichlet *dPtr)
{
  comment();
...
void PM_feelfem90smpi::DoDirichletCalcBoundaryValue(Dirichlet *dPtr)
{
  // used several times
...
void PM_feelfem90smpi::DoDirichletLoopEnd(Dirichlet *dPtr)
{
  com();
...
void PM_feelfem90smpi::doDirichletArgumentSequencePM(Dirichlet *dPtr)
{
  pushSource("(nsetno,              &");
  flushSource();
...
void PM_feelfem90smpi::doIthDirichletCallInSolvePM(Solve *solvePtr,int i)
{
  comment();
  pushSource("! No.");
  pushSourceInt(i+1);
...
void PM_feelfem90smpi::doIthDirichletCallInSolvePM2(Solve *solvePtr,int i)
{
  writeSource("end do");
  com();
}
