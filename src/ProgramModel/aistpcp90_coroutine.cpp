 ...
 *
 *  Filename : aistpcp90_coroutine.cpp
...
void PM_aistpcp90::GenerateCoSolveRoutines(Solve *solvePtr)
{
...
void PM_aistpcp90::pushIpdinfoRoutineName(int solveNo, int solveElementNo)
{
  char buf[BUFSIZ];
...
void PM_aistpcp90::pushEdevRoutineName(int solveNo, int solveElementNo)
{
  char buf[BUFSIZ];
...
void PM_aistpcp90::GenerateCoSolveIpdinfoRoutine(Solve *solvePtr)
{
...
void PM_aistpcp90::GenerateCoSolveEdevRoutine(Solve *solvePtr)
{
  SolveElement *sePtr = solvePtr->GetIthSolveElementPtr(0); // P2 FIXED
