 ...
 *
 *  Filename : aistpcp90_output.cpp
 *  Date     : 2002/09/30  (copied and modified from feelfem90_output.cpp)
 *  Modified : 
 *  
 *  Purpose  :
 *
...
void PM_aistpcp90::pushOutputRoutineName(Output *outputPtr)
{
  pushSource("output");
...
void PM_aistpcp90::DoMainScheme_output(Main *mainPtr,Output *outputPtr)
{
  pushSource("call ");
  pushOutputRoutineName(outputPtr);
  pushSource("(myrank,meshDat,firstEdatPtr,");     // myrank is added
...
void PM_aistpcp90::DoOutputRoutineHeader (Output *outputPtr)
{
  // module sentence
  ...
  pushOutputRoutineName(outputPtr);
  pushSource("(myrank,meshDat,firstEdatPtr,");
...
void PM_aistpcp90::DoOutputParameters( Output *outputPtr)
{
...
void PM_aistpcp90::DoOutputVariableDefinitions(Output *outputPtr)
{
...
void PM_aistpcp90::DoOutputMeshData(Output *outputPtr)
{
  // statements start here

  writeSource("if(myrank .NE. 0) return   ! only PE0 write the file");
  com();
...
void PM_aistpcp90::DoOutputStatement(Output *outputPtr)
{
...
void PM_aistpcp90::DoOutputReturnSequence(Output *outputPtr)
{
  writeSource("return");
  com();
...
// GiD
//void PM_aistpcp90::doOutputScalar(Output *outputPtr)
//{
//  pushSource("  ");
...
//}
//
//void PM_aistpcp90::doOutputFEMnode(Output *outputPtr)
//{
//  // do loop
//  writeSource("do i=1,npmax");
//  com();
...
//}
//
//void PM_aistpcp90::doOutputEWISEmaterial(Output *outputPtr)
//{
//  // do loop
//
//  //EDAT1
