 ...
 *
 *  Filename : aistpcp90_ewquad.cpp
 *  Date     : 2002/09/30  (copied from feelfem90_ewquad.cpp)
 *  Modified : 
 *  
...
void PM_aistpcp90::DoAssignParametersEwQuad(Assign *asPtr)
{
...
void PM_aistpcp90::DoAssignVariableDefinitionsEwQuad(Assign *asPtr)
{
  writeSource("! auto Variable Definitions");


  // variable for ex(NDP), etc. is defined in feelfem90_assign.cpp
...
void PM_aistpcp90::DoAssignInitializeEwQuad(Assign *asPtr)
{
  comment();
...
void PM_aistpcp90::DoAssignLoopStartEwQuad(Assign *asPtr)
{
  writeSource("do i=1,nelem");
  return;
}

void PM_aistpcp90::DoAssignAssignmentEwQuad(Assign *asPtr)
{
  // for x,y,z
...
void PM_aistpcp90::DoAssignLoopEndEwQuad(Assign *asPtr)
{
  writeSource("end do");
  com();
  return;
...
// CoRoutines
void PM_aistpcp90::DoAssignCoRoutineHeaderEwQuad( Assign *asPtr)
{
  // module sentence
...
void PM_aistpcp90::DoAssignCoRoutineParametersEwQuad  ( Assign *asPtr)
{
  comment();
    // for NPG, number of gauss points
  Quadrature *qPtr = asPtr->GetQuadraturePtr();
...
void PM_aistpcp90::DoAssignCoRoutineVariableDefinitionsEwQuad ( Assign *asPtr)
{
...
void PM_aistpcp90::DoAssignCoRoutineQuadratureSettingsEwQuad  ( Assign *asPtr)
{
...
void PM_aistpcp90::doAssignEwquadCalcInterpolation(Element *ePtr,
 				                   int      type )
{
...
void PM_aistpcp90::DoAssignCoRoutineStatementEwQuad( Assign *asPtr)
{
...
void PM_aistpcp90::doAssignEwiseQuad(Assign *asPtr)
{
...
void PM_aistpcp90::doAssignEwquadEvalAtGaussP(Assign *asPtr)
{
  EwiseQuadEcalInfo *ewqeiPtr = asPtr->GetEwQEcalInfoPtr();  
...
void PM_aistpcp90::doAssignEwquadRQconv(Assign *asPtr)
{
  EwiseQuadEcalInfo *ewqeiPtr = asPtr->GetEwQEcalInfoPtr();
  listIterator <Element *>itrE0( ewqeiPtr -> GetUsedElementPtrList());
  listIterator <Element *>itrE1( ewqeiPtr -> GetUsedD1ElementPtrList());
...
void PM_aistpcp90::doAssignEwquadJacobian(Assign *asPtr)
{
  EwiseQuadEcalInfo *ewqeiPtr = asPtr->GetEwQEcalInfoPtr();
...
void PM_aistpcp90::pushEwquadJacobiSub(int freedom,int *ndPattern,
				       const char *coor, 
...
void PM_aistpcp90::pushEwquadDiffSub_1st(Element *ePtr,
