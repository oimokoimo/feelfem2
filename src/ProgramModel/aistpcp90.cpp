...
//                 integer                                 :: ");
#define  AISTPCP90_INDENT 40

// Constructor, Destructor

PM_aistpcp90::PM_aistpcp90()
{
  return;
}

PM_aistpcp90::~PM_aistpcp90() = default;

// 2. I/O related

void PM_aistpcp90::OpenSource(const char *filename)
{
...
void PM_aistpcp90::OpenSource(const char *filename,int makeFlag)
{
...
void PM_aistpcp90::pushCoordinateSource(void)
{
...
void PM_aistpcp90::commentPM()
{
  writeSource("! aistpcp90 Program Model");
  return;
}
...
void PM_aistpcp90::MODULEzeroclearD(const char *varname, const char *size)
{
  char buf[BUFSIZ];
...
void PM_aistpcp90::MODULEzeroclearI(const char *varname, const char *size)
{
  char buf[BUFSIZ];
...
void PM_aistpcp90::MemAllocate(const char *arrayname,const char *index,
...
void PM_aistpcp90::MemDeallocate(const char *arrayname,const char *index,
				 const char *sizeFormula,int   type )
{
...
// F90 interface
void PM_aistpcp90::MODULEmallocF90(const char *varName,const char *varSize)
{
  pushSource("allocate(");
  pushSource(varName);
  pushSource("(");
...
void PM_aistpcp90::NameVariableInCalled( Variable *valPtr, string &name)
{
  char buf[BUFSIZ];
...
void PM_aistpcp90::pushVariableInCalled( Variable *valPtr)
{
  switch(valPtr->GetType()) {
  case VAR_FEM:
    pushSource("fem_");
...
void PM_aistpcp90::pushVariableNameInMain( Variable *varPtr)
{
...
void PM_aistpcp90::MainVariableAllocation( Variable *varPtr)
{
...
// variable memory allocation
void PM_aistpcp90::doMainVariableInitialValue( Variable *varPtr)
{
  switch(varPtr->GetType()) {
  case VAR_FEM:
  case VAR_EWISE:
...
void PM_aistpcp90::pushVariableListInMain( orderedPtrList <Variable *>vPtrLst)
{
  pushVariableListInCalled(vPtrLst);
}

void PM_aistpcp90::pushVariableListInCalled(orderedPtrList<Variable *>vPtrLst)
{
...
void PM_aistpcp90::pushVariableListInCalled( list <Variable *> varPtrLst)
{
...
void PM_aistpcp90::pushVariableListInCalledOnlyFEM(list <Variable *> varPtrLst)
{
  listIterator <Variable *> itr(varPtrLst);
  for(itr.init(); !itr;++itr) {
...
void PM_aistpcp90::pushVariableListInSolve(orderedPtrList<Variable*>varPtrLst)
{
...
/* Add 2000/05/09  (now only in aistpcp90) */
void PM_aistpcp90::pushFEMVariableInCalled( Variable *varPtr)
{
  pushSource("fem_");
...
void PM_aistpcp90::pushFEMVariableInSolve( Variable *varPtr)
{
...
///////////////////////////////////////////////////////////
void PM_aistpcp90::DefaultParameterBlock()
{
  //  comment();
  //  writeSource("! PM_aistpcp90::DefaultParameterBlock()");
  //  comment();

  doNothingNow("void PM_aistpcp90::DefaultParameterBlock()");
  return;

}


void PM_aistpcp90::PopReturn()                     // General in PM
{
  // ?????
  writeSource("      return");
  writeSource("      end");
...
/////////////////////////////////////////////////////////////////
void PM_aistpcp90::pushTypeDefCC(const char *s)
{
  int len = stringLength(s);
  pushSource(s);
  for(int i=0;i< AISTPCP90_INDENT - len; i++) {
    pushSource(" ");
  }
  pushSource(":: ");
  return;
...
void PM_aistpcp90::pushInteger4sc(void)
{
  pushSource(   "integer                                 :: ");
  return;
}

void PM_aistpcp90::pushInteger4pm(void)
{
  pushSource(   "integer,parameter                       :: ");
  return;
}

void PM_aistpcp90::pushInteger4In(void)
{
  pushSource(   "integer,intent(in)                      :: ");
  return;
}

void PM_aistpcp90::pushInteger4Ptr1(void)
{
  pushSource(   "integer,dimension(:)  ,pointer          :: ");
  return;
}

void PM_aistpcp90::pushInteger4Ptr2(void)
{
  pushSource(   "integer,dimension(:,:),pointer          :: ");
  return;
}

void PM_aistpcp90::pushLogical(void)
{
  pushSource(   "logical                                 :: ");
  return;
}
...
// write Integer
void PM_aistpcp90::writeInteger4sc(const char *str)
{
  pushInteger4sc();
  flushSource(str);
  return;
...
void PM_aistpcp90::writeInteger4pm(const char *str)
{
  pushInteger4pm();
  flushSource(str);
  return;
...
void PM_aistpcp90::writeInteger4In(const char *str)
{
  pushInteger4In();
  flushSource(str);
  return;
...
void PM_aistpcp90::writeInteger4Ptr1(const char *str)
{
  pushInteger4Ptr1();
  flushSource(str);
  return;
...
void PM_aistpcp90::writeInteger4Ptr2(const char *str)
{
  pushInteger4Ptr2();
  flushSource(str);
  return;
...
// real*8 
void PM_aistpcp90::pushReal8sc(void)
{
  pushSource(   "real(kind=REAL8)                        :: ");
  return;
}

void PM_aistpcp90::pushReal8pm(void)
{
  pushSource(   "real(kind=REAL8),parameter              :: ");
  return;
}

void PM_aistpcp90::pushReal8Ptr1(void)
{
  pushSource(   "real(kind=REAL8),dimension(:)  ,pointer :: ");
  return;
}

void PM_aistpcp90::pushReal8Ptr2(void)
{
  pushSource(   "real(kind=REAL8),dimension(:,:),pointer :: ");
  return;
}

void PM_aistpcp90::pushReal8Array1(void)
{
...
// write real*8
void PM_aistpcp90::writeReal8sc(const char *str)
{
  pushReal8sc();
  flushSource(str);
  return;
...
void PM_aistpcp90::writeReal8pm(const char *str)
{
  pushReal8pm();
  flushSource(str);
  return;
...
void PM_aistpcp90::writeReal8Ptr1(const char *str)
{
  pushReal8Ptr1();
  flushSource(str);
  return;
...
void PM_aistpcp90::writeReal8Ptr2(const char *str)
{
  pushReal8Ptr2();
  flushSource(str);
  return;
...
void PM_aistpcp90::writeLogical(const char *str)
{
  pushLogical();
  flushSource(str);
  return;
...
void PM_aistpcp90::CoordinateVariableDeclaration(void)
{
  switch(getSpaceDimension()){
  case 1:
    pushReal8Ptr1();
...
void PM_aistpcp90::DoArgumentSequenceFromMain
  ...
  orderedPtrList <Variable *>&varPtrLst       )
{
  ...
  pushSource(subroutineName);
  pushSource("(myrank,nprocs,iedom,                    &");// iedom is P4 PCP
  flushSource();
  pushSource("   npmax,");     
...
/////////////////////////////////////////////////////////////////////////////
void PM_aistpcp90::MainVariableDeclaration(Variable *varPtr)
{
  ArgumentVariableDeclaration(varPtr); // in fortran90,  same as Arg...
  return;
}

void PM_aistpcp90::ArgumentVariableDeclaration(Variable *varPtr)
{
  string a;
...
/////////////////////////////////////////////////////////////////////////////
void PM_aistpcp90::ArgumentVariableDeclarationLst(list <Variable *>& varPtrLst)
{
  listIterator <Variable *> itr(varPtrLst);
  for(itr.init(); !itr;++itr) {
...
void PM_aistpcp90::MPIinclude(void)
{
...
/////////////////////////////////////////////////////////////////
void PM_aistpcp90::SourceStarters()
{
  copyright();
  commentPM();
  timestamp();
...
void PM_aistpcp90::F90useAlways(void)
{
...
void PM_aistpcp90::F90useFEMDataType(void)
{
