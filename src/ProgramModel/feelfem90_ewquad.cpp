...
void PM_feelfem90::DoAssignParametersEwQuad(Assign *asPtr)
{
...
void PM_feelfem90::DoAssignVariableDefinitionsEwQuad(Assign *asPtr)
{
...
void PM_feelfem90::DoAssignInitializeEwQuad(Assign *asPtr)
{
  comment();
...
void PM_feelfem90::DoAssignLoopStartEwQuad(Assign *asPtr)
{
  writeSource("do i=1,nelem");
  return;
}

void PM_feelfem90::DoAssignAssignmentEwQuad(Assign *asPtr)
{
  // for x,y,z
...
void PM_feelfem90::DoAssignLoopEndEwQuad(Assign *asPtr)
{
  writeSource("end do");
  com();
  return;
...
// CoRoutines
void PM_feelfem90::DoAssignCoRoutineHeaderEwQuad( Assign *asPtr)
{
  // module sentence
...
void PM_feelfem90::DoAssignCoRoutineParametersEwQuad  ( Assign *asPtr)
{
  comment();
    // for NPG, number of gauss points
  Quadrature *qPtr = asPtr->GetQuadraturePtr();
...
void PM_feelfem90::DoAssignCoRoutineVariableDefinitionsEwQuad ( Assign *asPtr)
{
...
void PM_feelfem90::DoAssignCoRoutineQuadratureSettingsEwQuad  ( Assign *asPtr)
{
...
void PM_feelfem90::doAssignEwquadCalcInterpolation(Element *ePtr,
 				                   int      type )
{
...
void PM_feelfem90::DoAssignCoRoutineStatementEwQuad( Assign *asPtr)
{
...
void PM_feelfem90::doAssignEwiseQuad(Assign *asPtr)
{
...
void PM_feelfem90::doAssignEwquadEvalAtGaussP(Assign *asPtr)
{
  EwiseQuadEcalInfo *ewqeiPtr = asPtr->GetEwQEcalInfoPtr();  
...
void PM_feelfem90::doAssignEwquadRQconv(Assign *asPtr)
{
  EwiseQuadEcalInfo *ewqeiPtr = asPtr->GetEwQEcalInfoPtr();
  listIterator <Element *>itrE0( ewqeiPtr -> GetUsedElementPtrList());
  listIterator <Element *>itrE1( ewqeiPtr -> GetUsedD1ElementPtrList());
...
void PM_feelfem90::doAssignEwquadJacobian(Assign *asPtr)
{
  EwiseQuadEcalInfo *ewqeiPtr = asPtr->GetEwQEcalInfoPtr();
...
void PM_feelfem90::pushEwquadJacobiSub(int freedom,int *ndPattern,
				       const char *coor, 
...
void PM_feelfem90::pushEwquadDiffSub_1st(Element *ePtr,
