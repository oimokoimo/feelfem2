...
void PM_aistpcp90::GenerateCoSolveEcalRoutines(SolveElement *sePtr)
{
  GenerateEsetRoutines( sePtr );
  return;
}

void PM_aistpcp90::pushEsetRoutineName(int solveNo,int solveElementNo,
				       int quadNo                      )
{
  char buf[BUFSIZ];
...
void PM_aistpcp90::GenerateEsetRoutines(SolveElement *sePtr)
{
...
void PM_aistpcp90::doEsetCalcInterpolation(SolveElement *sePtr,
...
void PM_aistpcp90::doEsetCalcInterpolationSub( int quadNo,
					       SolveElement *sePtr,
					       Element *ePtr,
					       int type             )
{
