...
PM_feelfem90smpi::~PM_feelfem90smpi() = default;


// 2. I/O related

void PM_feelfem90smpi::OpenSource(const char *filename)
{
...
void PM_feelfem90smpi::OpenSource(const char *filename,int makeFlag)
{
...
const char *PM_feelfem90smpi::GetSourceName( const char *routineName)
{
...
void PM_feelfem90smpi::MODULEzeroclearD(const char *varname, const char *size)
{
  char buf[BUFSIZ];
...
void PM_feelfem90smpi::MODULEzeroclearI(const char *varname, const char *size)
{
  char buf[BUFSIZ];
...
// F90 interface
void PM_feelfem90smpi::MODULEmallocF90(const char *varName,const char *varSize)
{
  pushSource("allocate(");
  pushSource(varName);
  pushSource("(");
...
/////////////////////////////////////////////////////////////////
void PM_feelfem90smpi::pushTypeDefCC(const char *s)
{
