 ...
 *
 *  Filename : feelfem90_integral.cpp
 *  Date     : 2002/11/17
 *  
...
void PM_feelfem90::DoAssignInitializeIntegral(Assign *asPtr)
{
  comment();
...
void PM_feelfem90::DoAssignAssignmentIntegral(Assign *asPtr)
{
...
// CoRoutines
void PM_feelfem90::DoAssignCoRoutineHeaderIntegral( Assign *asPtr)
{
  // module sentence
...
void PM_feelfem90::DoAssignCoRoutineVariableDefinitionsIntegral( Assign *asPtr)
{
...
void PM_feelfem90::DoAssignCoRoutineStatementIntegral( Assign *asPtr)
{
...
void PM_feelfem90::doAssignIntegral(Assign *asPtr)
{
  ...
  for(itr.init();!itr;++itr ) {
    ...
    case VAR_FEM:
      std::cerr << "ewise variable must not be appeared here.(feelfem90)\n";
      assert(1==0);  
      break;
...
void PM_feelfem90::DoAssignLoopEndIntegral(Assign *asPtr)
{
  writeSource("end do");
  com();
  return;
