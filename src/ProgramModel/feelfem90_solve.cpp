 ...
 *
 *  Filename : feelfem90_solve.cpp
 *  Date     : 2000/12/08
 *  Modified : 2000/12/08
 *  
 *  Purpose  : solve routine generator for feelfem90 program model
...
const char *PM_feelfem90::GetSolveRoutineName( int no )
{
  char *ptr = new char[8];
...
// Do Solve functions
///////////////////////////////////////
void PM_feelfem90::DoSolveStarters()
{
...
void PM_feelfem90::F90useSolvePM(Solve *solvePtr)
{
...
void PM_feelfem90::DoSolveVariableDefinitionsPM(Solve *solvePtr)
{
  // auto variables
...
// 2-2-2 Parameters
void PM_feelfem90::DoSolveParametersPM( Solve *solvePtr)
{
...
void PM_feelfem90::DoSolveInitialDefPM(Solve *solvePtr)
{
  int dconds = solvePtr->GetDconds();
  int nconds = solvePtr->GetNconds();
...
void PM_feelfem90::DoSolveInitializerPM(Solve *solvePtr)
{
  //  report routine
...
void PM_feelfem90::DoSolveReport( int no, const char *s)
{
  pushSource(" call report('solve");
  pushSourceInt(no);
  pushSource(" : ");
...
// Degree of freedom
void PM_feelfem90::DoSolveDegreeOfFreedom(Solve *solvePtr)
{
...
void PM_feelfem90::DoSolveAssemblyPreparation(Solve *solvePtr)
{
...
void PM_feelfem90::DoSolveBoundaryDataPreparation(Solve *solvePtr)
{
...
///////////////////////////////////////
void PM_feelfem90::DoSolveReturnSequence(Solve *solvePtr)
{
...
void PM_feelfem90::doSolveFreeMemoryPM(Solve *solvePtr)
{
