...
void PM_aistpcp90::pushEcalRoutineName(SolveElement *sePtr)
{
  pushSource("ecal");
...
void PM_aistpcp90::pushEcalArgumentLstInElem(SolveElement *sePtr,
					     orderedPtrList<Variable *>vPtrLst)
{
  ...
  for(itrV.init(); !itrV ; ++itrV) {
	...
	pushSource("ew_");
	pushSource(itrV()->GetName());
	pushSource("(1:");                       // partial array for f90
...
void PM_aistpcp90::pushEcalArgumentLstInEcal(SolveElement *sePtr,
					     orderedPtrList<Variable *>vPtrLst)
{
  listIterator <Variable *>itrV(vPtrLst);
...
// dependent on TermConvert
void PM_aistpcp90::EcalArgumentVariableDeclarationLst(SolveElement *sePtr,
						      orderedPtrList
						      <Variable *>&vPtrLst)
{
  listIterator <Variable *>itrV(vPtrLst);
...
void PM_aistpcp90::DoEcalRoutineHeader(SolveElement *sePtr)
{
...
void PM_aistpcp90::doEcalArgumentSequence(SolveElement *sePtr)
{
...
void PM_aistpcp90::doEcalDeclareArgumentVariables(SolveElement *sePtr)
{
  int ielemNodes = sePtr->GetIelemNodes();
...
void PM_aistpcp90::DoEcalParameters(SolveElement *sePtr)
{
...
void PM_aistpcp90::DoEcalVariableDefinitions(SolveElement *sePtr )
{
...
void PM_aistpcp90::EcalElementMatRHSVariableDeclaration(int solveNo,int elemNo)
{
  pushReal8sc();
  flushSource("ea,eb");
  return;
...
void PM_aistpcp90::EcalElementMatRHSCommon(int solveNo, int elemNo)
{
...
void PM_aistpcp90::EcalQuadCommon(SolveElement *sePtr,
				  DiscretizedComponent *dcPtr,
...
void PM_aistpcp90::DoEcalReturnSequence(SolveElement *sePtr)
{
...
void PM_aistpcp90::DoEcalElementMatInitialize(SolveElement *sePtr)
{
...
void PM_aistpcp90::DoEcalQuadLoopStart(int quadNo, SolveElement *sePtr)
{
  comment();
...
void PM_aistpcp90::DoEcalQuadLoopEnd(int quadNo, SolveElement *sePtr)
{
  com();
...
void PM_aistpcp90::DoEcalCalcJacobian(int quadNo, SolveElement *sePtr)
{
...
void PM_aistpcp90::pushEcalJacobiSub(int quadNo,int freedom,int *ndPattern,
...
void PM_aistpcp90::pushEcalCoordSub(int quadNo, Element *ePtr,
...
void PM_aistpcp90::DoEcalSetValAtGaussP(int quadNo, SolveElement *sePtr)
{
...
void PM_aistpcp90::DoEcalCalcElementMatRHS(int quadNo, SolveElement *sePtr)
{
  comment();
...
void PM_aistpcp90::pushEcalDiffSub_1st(int quadNo,Element *ePtr,int dim,
				       int no,int diffType              )
{
  pushSource("  q");
