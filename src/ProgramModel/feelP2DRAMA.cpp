...
PM_feelP2DRAMA::~PM_feelP2DRAMA() = default;


//////////////////////////////////////////////////////////////////
void PM_feelP2DRAMA::OpenSource(const char *filename)
{
...
void PM_feelP2DRAMA::OpenSource(const char *filename, int makeFlag)
{
...
const char *PM_feelP2DRAMA::GetSourceName( const char *routineName)
{
...
void PM_feelP2DRAMA::MODULEzeroclearD(const char *varname,const char *size)
{
  char buf[BUFSIZ];
...
void PM_feelP2DRAMA::MODULEzeroclearI(const char *varname,const char *size)
{
  char buf[BUFSIZ];
...
void PM_feelP2DRAMA::MODULEmalloc(const char *ptr,const char *comment,const char *size, const char *type)
{
  mallocF77(ptr,comment,size,type);
  return;
}

void PM_feelP2DRAMA::MODULEmallocERT(const char *ptr,const char *comment,const char *size, const char *type)
{
...
/////////////////////////////////////////////////////////////////
const char *PM_feelP2DRAMA::GetSolveRoutineName( int no )
{
  char *ptr = new char[8];
...
const char *PM_feelP2DRAMA::GetElemRoutineName( int solveNo )
{
...
void PM_feelP2DRAMA::DoElemCallEcalRoutine(SolveElement *sePtr,int flag)
{
  ...
  if(flag == MY_ELEMENT) {
    ...
    for(itr2.init();!itr2;++itr2) {
      pushSource(",");
      string a = itr2();
      if(strindex((const char *)a,"fem_")) { // SUPER LIMITED!!! ECAL P2 OIMO oimo
	a = SuperRinjiEcalP2DRAMA(a);
      }
      pushSource(a);
    }
...
const char *PM_feelP2DRAMA::dirichletP2DOTEMP( const char *st )
{
  int strindex(const char *,const char *);
  int i;
  //  char buf[BUFSIZ];
...
const char *PM_feelP2DRAMA::GetDirichletRoutineName(int solveNo, int dcondNo)
{
...
//////////////////////////////////////////
const char *PM_feelP2DRAMA::GetNeumannRoutineName(int solveNo, int ncondNo)
{
...
void PM_feelP2DRAMA::pushSuperDotempDRAMAneumannFEMval(const char *left,const char *right)
{
...
string PM_feelP2DRAMA::SuperRinjiEcalP2DRAMA( const char *s)
{
  char  femname[100];
  char  number [100];
  char  val    [BUFSIZ];
