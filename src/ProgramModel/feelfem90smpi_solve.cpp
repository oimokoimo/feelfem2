 ...
 *
 *  Filename : feelfem90smpi_solve.cpp
 *  Date     : 2003/01/04 (copied from feelfem90)
 *  Modified : 
 *  
 *  Purpose  : solve routine generator for feelfem90smpi program model
...
const char *PM_feelfem90smpi::GetSolveRoutineName( int no )
{
  char *ptr = new char[8];
...
// Do Solve functions
///////////////////////////////////////
void PM_feelfem90smpi::DoSolveStarters()
{
...
void PM_feelfem90smpi::F90useSolvePM(Solve *solvePtr)
{
...
void PM_feelfem90smpi::DoSolveVariableDefinitionsPM(Solve *solvePtr)
{
  // auto variables
...
// 2-2-2 Parameters
void PM_feelfem90smpi::DoSolveParametersPM( Solve *solvePtr)
{
...
void PM_feelfem90smpi::DoSolveInitialDefPM(Solve *solvePtr)
{
  int dconds = solvePtr->GetDconds();
  int nconds = solvePtr->GetNconds();
...
void PM_feelfem90smpi::DoSolveInitializerPM(Solve *solvePtr)
{
...
void PM_feelfem90smpi::DoSolveReport( int no, const char *s)
{
...
// Degree of freedom
void PM_feelfem90smpi::DoSolveDegreeOfFreedom(Solve *solvePtr)
{
...
void PM_feelfem90smpi::DoSolveAssemblyPreparation(Solve *solvePtr)
{
...
void PM_feelfem90smpi::DoSolveBoundaryDataPreparation(Solve *solvePtr)
{
...
///////////////////////////////////////
void PM_feelfem90smpi::DoSolveReturnSequence(Solve *solvePtr)
{
...
void PM_feelfem90smpi::doSolveFreeMemoryPM(Solve *solvePtr)
{
  COMMENTlong("ProgramModel dependent memory deallocation");
  
  writeSource("if(myrank .eq. 0) then");
  com();
  writeSource(" deallocate(ipd)");
  writeSource(" deallocate(ipf)");
  com();
