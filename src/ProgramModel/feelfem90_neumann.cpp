 ...
 *
 *  Filename : feelfem90_neumann.cpp
 *  Date     : 2000/12/08
 *  Modified : 2000/12/08
 *  Modified : 2001/02/02 orderedPtrList
 *  Modified : 2002/04/10 for real implementation
 *  Modified : 2002/06/27 data set 
 *  
...
void PM_feelfem90::DoNeumannParametersPM(Neumann *nPtr)
{
  /* parameter NPG */
...
void PM_feelfem90::F90useNeumannPM()
{
  F90useFEMDataType();
  F90useAlways();
}
...
void PM_feelfem90::DoNeumannArgumentVariableDefinitionsPM(Neumann *nPtr)
{
...
void PM_feelfem90::DoNeumannAutoVariableDefinitionsPM(Neumann *nPtr)
{
...
void PM_feelfem90::DoNeumannInitializerPM(Neumann *nPtr)
{
  int no;
...
void PM_feelfem90::DoNeumannBoundaryElementLoopStartPM(Neumann *nPtr)
{
...
void PM_feelfem90::DoNeumannBoundaryElementLoopEndPM(Neumann *nPtr)
{
...
void PM_feelfem90::pushSuperDotempneumannFEMval(const char *left,const char *right)
{
...
void PM_feelfem90::DoNeumannReturnSequencePM(Neumann *nPtr)
{
  com();
...
void PM_feelfem90::doNeumannEsetCalcInterpolationSub(Neumann *nPtr,
						     Element *bePtr,
						     int      diffType   )
{
...
void PM_feelfem90::doNeumannEcalSetValAtGaussP( Neumann *nPtr )
{
  DiscretizedComponent *dcPtr        = nPtr->GetDiscretizedComponentPtr();
  EcalInfo             *ecalInfoPtr  = nPtr->GetEcalInfoPtr();
...
void PM_feelfem90::pushNeumannEcalCoordSub(Neumann    *nPtr,
					   const char *coord)
{
...
void PM_feelfem90::pushNeumannCoordDiff(Neumann *nPtr,
...
void PM_feelfem90::doIthNeumannCallInSolvePM(Solve *solvePtr, int i)
{
...
void PM_feelfem90::doIthNeumannCallInSolvePM2(Solve *solvePtr, int i)
{
  writeSource("end do");
  com();
}
