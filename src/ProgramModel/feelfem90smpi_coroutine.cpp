 ...
 *
 *  Filename : feelfem90smpi_coroutine.cpp
...
void PM_feelfem90smpi::GenerateCoSolveRoutines(Solve *solvePtr)
{
...
void PM_feelfem90smpi::pushIpdinfoRoutineName(int solveNo, int solveElementNo)
{
  char buf[BUFSIZ];
...
void PM_feelfem90smpi::pushEdevRoutineName(int solveNo, int solveElementNo)
{
  char buf[BUFSIZ];
...
void PM_feelfem90smpi::GenerateCoSolveIpdinfoRoutine(Solve *solvePtr)
{
...
void PM_feelfem90smpi::GenerateCoSolveEdevRoutine(Solve *solvePtr)
{
  SolveElement *sePtr = solvePtr->GetIthSolveElementPtr(0); // P2 FIXED
