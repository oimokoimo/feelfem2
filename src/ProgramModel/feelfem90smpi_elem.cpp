 ...
 *
 *  Filename : feelfem90smpi_elem.cpp
 *  Date     : 2003/01/04 (copied from feelfem90)
 *  Modified : 
 *  
 *  Purpose  : elem related routine generator for feelfem90smpi model
...
string PM_feelfem90smpi::SuperRinjiEcalP2DRAMA(const  char *s)
{
  char  femname[100];
  char  number [100];
  char  val    [BUFSIZ];
...
const char *PM_feelfem90smpi::GetElemRoutineName( int solveNo )
{
...
void PM_feelfem90smpi::pushElemRoutineName(int solveNo)
{
  const char *ptr;
...
void PM_feelfem90smpi::F90useElemPM(SolveElement *sePtr)
{
...
// ###  Variable definitons
void PM_feelfem90smpi::doElemDeclareArgumentVariablesPM(SolveElement *sePtr)
{
...
void PM_feelfem90smpi::DoElemVariableDefinitionsPM(SolveElement *sePtr)
{
...
void PM_feelfem90smpi::doElemStarters()
{
  SourceStarters();
  return;
}
...
void PM_feelfem90smpi::DoElemParameters(SolveElement *sePtr)
{
...
void PM_feelfem90smpi::DoElemInitializer(SolveElement *sePtr)
{
...
void PM_feelfem90smpi::DoElemElementLoopStart(int flag)
{
  writeSource("do 100 i=1,nelem");         // just this!  ^^;
}


void PM_feelfem90smpi::DoElemCallEcalRoutine(SolveElement *sePtr,int flag)
{
  int strindex(const char *, const char *);
  orderedPtrList <Variable *> varPtrLst = sePtr->GetVariablePtrLst();
  listIterator <Variable *> itr(varPtrLst);
  ...
  pushEcalArgumentLstInElem( sePtr, varPtrLst );   //  feelfem90smpi_ecal.cpp
...
void PM_feelfem90smpi::DoElemElementLoopEnd(int flag)
{
...
void PM_feelfem90smpi::DoElemReturnSequence(SolveElement *sePtr)
{
