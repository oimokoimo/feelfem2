 ...
 *
 *  Filename : feelfem90DRAMA_ecal.cpp
 *  Date     : 2003/02/13 (Copied from feelfem90_ecal.cpp)
 *  Modified : 
 *  
...
const char *PM_feelfem90DRAMA::GetEcalRoutineName( int solveNo, int elemNo) 
{
...
void PM_feelfem90DRAMA::pushEcalRoutineName(SolveElement *sePtr)
{
  pushSource("ecal");
...
void PM_feelfem90DRAMA::pushEcalArgumentLstInElem(SolveElement *sePtr,
...
void PM_feelfem90DRAMA::pushEcalArgumentLstInEcal(SolveElement *sePtr,
					     orderedPtrList<Variable *>vPtrLst)
{
  listIterator <Variable *>itrV(vPtrLst);
...
// dependent on TermConvert
void PM_feelfem90DRAMA::EcalArgumentVariableDeclarationLst(SolveElement *sePtr,
						      orderedPtrList
						      <Variable *>&vPtrLst)
{
  listIterator <Variable *>itrV(vPtrLst);
...
void PM_feelfem90DRAMA::DoEcalRoutineHeader(SolveElement *sePtr)
{
...
void PM_feelfem90DRAMA::doEcalArgumentSequence(SolveElement *sePtr)
{
...
void PM_feelfem90DRAMA::doEcalDeclareArgumentVariables(SolveElement *sePtr)
{
  int ielemNodes = sePtr->GetIelemNodes();
...
void PM_feelfem90DRAMA::DoEcalParameters(SolveElement *sePtr)
{
...
void PM_feelfem90DRAMA::DoEcalVariableDefinitions(SolveElement *sePtr )
{
...
void PM_feelfem90DRAMA::EcalElementMatRHSVariableDeclaration(int solveNo,int elemNo)
{
  pushReal8sc();
  flushSource("ea,eb");
  return;
...
void PM_feelfem90DRAMA::EcalElementMatRHSCommon(int solveNo, int elemNo)
{
...
void PM_feelfem90DRAMA::EcalQuadCommon(SolveElement *sePtr,
				  DiscretizedComponent *dcPtr,
...
void PM_feelfem90DRAMA::DoEcalReturnSequence(SolveElement *sePtr)
{
...
void PM_feelfem90DRAMA::DoEcalElementMatInitialize(SolveElement *sePtr)
{
...
void PM_feelfem90DRAMA::DoEcalQuadLoopStart(int quadNo, SolveElement *sePtr)
{
  comment();
...
void PM_feelfem90DRAMA::DoEcalQuadLoopEnd(int quadNo, SolveElement *sePtr)
{
  com();
...
void PM_feelfem90DRAMA::DoEcalCalcJacobian(int quadNo, SolveElement *sePtr)
{
...
void PM_feelfem90DRAMA::pushEcalJacobiSub(int quadNo,int freedom,int *ndPattern,
...
void PM_feelfem90DRAMA::pushEcalCoordSub(int quadNo, Element *ePtr,
...
void PM_feelfem90DRAMA::DoEcalSetValAtGaussP(int quadNo, SolveElement *sePtr)
{
...
void PM_feelfem90DRAMA::DoEcalCalcElementMatRHS(int quadNo, SolveElement *sePtr)
{
  comment();
...
void PM_feelfem90DRAMA::pushEcalDiffSub_1st(int quadNo,Element *ePtr,int dim,
				       int no,int diffType              )
{
  pushSource("  q");
