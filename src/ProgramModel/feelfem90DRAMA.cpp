...
PM_feelfem90DRAMA::~PM_feelfem90DRAMA() = default;

// 2. I/O related


void PM_feelfem90DRAMA::OpenSource(const char *filename)
{
...
void PM_feelfem90DRAMA::OpenSource(const char *filename,int makeFlag)
{
...
const char *PM_feelfem90DRAMA::GetSourceName( const char *routineName)
{
...
void PM_feelfem90DRAMA::MODULEzeroclearD(const char *varname, const char *size)
{
  char buf[BUFSIZ];
...
void PM_feelfem90DRAMA::MODULEzeroclearI(const char *varname, const char *size)
{
  char buf[BUFSIZ];
...
// F90 interface
void PM_feelfem90DRAMA::MODULEmallocF90(const char *varName,const char *varSize)
{
  pushSource("allocate(");
  pushSource(varName);
  pushSource("(");
...
/////////////////////////////////////////////////////////////////
void PM_feelfem90DRAMA::pushTypeDefCC(const char *s)
{
