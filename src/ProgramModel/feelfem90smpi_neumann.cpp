 ...
 *
 *  Filename : feelfem90smpi_neumann.cpp
...
const char *PM_feelfem90smpi::GetNeumannRoutineName(int solveNo, int ncondNo)
{
...
void PM_feelfem90smpi::pushNeumannRoutineName(int solveNo, int ncondNo)
{
  char buf[BUFSIZ];
...
void PM_feelfem90smpi::DoNeumannParametersPM(Neumann *nPtr)
{
  /* parameter NPG */
...
void PM_feelfem90smpi::F90useNeumannPM()
{
  F90useFEMDataType();
  F90useAlways();
}
...
void PM_feelfem90smpi::DoNeumannArgumentVariableDefinitionsPM(Neumann *nPtr)
{
...
void PM_feelfem90smpi::DoNeumannAutoVariableDefinitionsPM(Neumann *nPtr)
{
...
void PM_feelfem90smpi::DoNeumannInitializerPM(Neumann *nPtr)
{
  int no;
...
void PM_feelfem90smpi::DoNeumannBoundaryElementLoopStartPM(Neumann *nPtr)
{
...
void PM_feelfem90smpi::DoNeumannBoundaryElementLoopEndPM(Neumann *nPtr)
{
...
void PM_feelfem90smpi::pushSuperDotempneumannFEMval(const char *left,const char *right)
{
...
void PM_feelfem90smpi::DoNeumannReturnSequencePM(Neumann *nPtr)
{
  com();
...
void PM_feelfem90smpi::doNeumannEsetCalcInterpolationSub(Neumann *nPtr,
						     Element *bePtr,
						     int      diffType   )
{
...
void PM_feelfem90smpi::doNeumannEcalSetValAtGaussP( Neumann *nPtr )
{
  DiscretizedComponent *dcPtr        = nPtr->GetDiscretizedComponentPtr();
  EcalInfo             *ecalInfoPtr  = nPtr->GetEcalInfoPtr();
...
void PM_feelfem90smpi::pushNeumannEcalCoordSub(Neumann    *nPtr,
					   const char *coord)
{
...
void PM_feelfem90smpi::pushNeumannCoordDiff(Neumann *nPtr,
...
void PM_feelfem90smpi::doIthNeumannCallInSolvePM(Solve *solvePtr, int i)
{
...
void PM_feelfem90smpi::doIthNeumannCallInSolvePM2(Solve *solvePtr, int i)
{
  writeSource("end do");
  com();
}
