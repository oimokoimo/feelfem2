...
void MainScheme::MainRoutineInitialize( Main *mainPtr )
 { std::cout << "This is virtual funcs mainroutineinitialize\n"; }

void MainScheme::MainRoutineHeader( Main *mainPtr )
 { std::cout << "This is virtual funcs(Mainroutineheader)\n"; }

void MainScheme::MainRoutineParameters( Main *mainPtr )
 { std::cout << "This is virtual funcs(mainroutineparameters)\n"; }

void MainScheme::MainRoutineVariableDefinitions( Main *mainPtr )
 { std::cout << "This is virtual funcs(mainroutinevariabledefinitions)\n"; }

void MainScheme::MainRoutineInitializer( Main *mainPtr )
 { std::cout << "This is virtual funcs(mainroutineinitializer)\n"; }

void MainScheme::MainRoutineReportInitializer( Main *mainPtr )
 { std::cout << "This is virtual funcs(mainroutinereportinitializer)\n"; }

void MainScheme::MainRoutineDataInput( Main *mainPtr )
 { std::cout << "This is virtual funcs(mainroutinedatainput)\n"; }

void MainScheme::MainRoutineSchemeStart( Main *mainPtr )
 { std::cout << "This is virtual funcs(mainroutineschemestart)\n"; }

void MainScheme::MainRoutineInitialValue( Main *mainPtr )
 { std::cout << "This is virtual funcs(mainroutineinitialvalue)\n"; }

void MainScheme::MainGenerateScheme( Main *mainPtr )
 { std::cout << "This is virtual funcs(maingeneratescheme)\n"; }

void MainScheme::MainRoutineSchemeFinish( Main *mainPtr )
 { std::cout << "This is virtual funcs(mainroutineschemefinish)\n"; }

void MainScheme::MainRoutineTerminationSequence( Main *mainPtr )
 { std::cout << "This is virtual funcs(MainRoutineTerminateionSequence)\n"; }

void MainScheme::MainRoutineTerminate( Main *mainPtr )
 { std::cout << "This is virtual funcs(MainRoutineTerminate)\n"; }
