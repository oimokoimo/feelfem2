 ...
 *
 *  Filename : SNelementAssignment.hpp
 *  Date     : 2001/03/26
 *  Modified : 
 *  
 *  Purpose  : elementAssignment class for parser  (reference aumc)
 *  
 *
...
#ifndef FEM_SYNTAX_ELEMENTASSIGNMENT
#define FEM_SYNTAX_ELEMENTASSIGNMENT
...
class SNelementAssignment : public SNunit {
public:

  friend elementEvalGinac;    // to access leftVarName


  SNelementAssignment( char *nm, Expression *ptr) 
    :SNunit("elementAssignment",SN_ELEMENTASSIGNMENT) 
  { 
    leftVarName = nm; 
    exprPtr        = ptr;
