...
void SNsub::exprPrint( char *buf, int flag , void *ptr1,void *ptr2) 
{
  int charPointer;     
  ...
  if(charPointer + 1 + 1 > MAX_EXPRPRINT_BUF) {
    abortExit("Too long expression in SNsub");
  }
  *(buf+charPointer  ) = '-' ;
  *(buf+charPointer+1) = '\0';
...
int SNsub::howManyNotDefinedVariable( int flag , void *ptr1,void *ptr2) 
{
  int ret,ret1,ret2;
...
int SNsub::howManyNotDefinedFunction( int flag , void *ptr1,void *ptr2) 
{
  int ret,ret1,ret2;
...
int SNsub::howManyNotAssignedVariable( int flag , void *ptr1,void *ptr2) 
{
  int ret,ret1,ret2;
