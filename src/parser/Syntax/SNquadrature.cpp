...
SNquadrature::SNquadrature( const char *nm,char *elem, stack <SNunit *>&parseQuadratureStack)
...
void SNquadrature::print(std::ostream &ost) 
{
  ost << "Quadrature "<< name << "[" <<elementShape <<"]" << std::endl;
