...
void SNequal::exprPrint( char *buf, int flag , void *ptr1,void *ptr2) 
{
  int charPointer;
  ...
  case EXPRPRINT_REPLACE_EVALPAIR:
    ...
    if(charPointer + 2 + 1 > MAX_EXPRPRINT_BUF) {
      abortExit("Too long expression in SNequal");
    }
    *(buf+charPointer  ) = '=' ;
    *(buf+charPointer+1) = '=' ;
    *(buf+charPointer+2) = '\0';
...
int SNequal::howManyNotDefinedVariable(int flag , void *ptr1,void *ptr2) 
{
  int ret1,ret2;
...
int SNequal::howManyNotDefinedFunction(int flag , void *ptr1,void *ptr2) 
{
  int ret1,ret2;
...
int SNequal::howManyNotAssignedVariable(int flag , void *ptr1,void *ptr2) 
{
  int ret1,ret2;
