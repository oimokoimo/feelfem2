...
void SNge::exprPrint( char *buf, int flag , void *ptr1,void *ptr2) 
{
  int charPointer;
  ...
  case EXPRPRINT_REPLACE_EVALPAIR:
    ...
    if(charPointer + 2 + 1 > MAX_EXPRPRINT_BUF) {
      abortExit("Too long expression in SNge");
    }
    *(buf+charPointer  ) = '>' ;
    *(buf+charPointer+1) = '=' ;
    *(buf+charPointer+2) = '\0';
...
int SNge::howManyNotDefinedVariable(int flag , void *ptr1,void *ptr2) 
{
  int ret1,ret2;
...
int SNge::howManyNotDefinedFunction(int flag , void *ptr1,void *ptr2) 
{
  int ret1,ret2;
...
int SNge::howManyNotAssignedVariable(int flag , void *ptr1,void *ptr2) 
{
  int ret1,ret2;
