...
#ifndef FEM_SYNTAX_NEQUAL
#define FEM_SYNTAX_NEQUAL

#include "../../class/string.hpp"
#include "SNunit.hpp"

class SNnequal : public SNunit {
public:
  SNnequal(SNunit *a1,SNunit *a2) : SNunit("nequal",SN_NEQUAL),arg1(a1),arg2(a2)
  {}
