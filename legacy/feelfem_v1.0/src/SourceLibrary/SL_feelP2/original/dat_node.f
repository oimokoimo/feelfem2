...
c ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 8001 read(io_in,9001,end=8900) inp,xx
 9001 format(i8,f10.5)
      if(inp .eq. 0) return
      x(inp) = xx
      goto 8001
c --------------------------------------------------------------------
 8900 write(io_stderr,*) 'NODE DATA ERROR'
      stop 'inp_node'
      end
      subroutine dat_node2( x , y)
c ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
c     feel p2 fort77 program
c     Copyright(C) NEC Corporation 1993
c ======================================
...
c --------------------------------------------------------------------
     ...
     &                 n_ewise(MAX_EWISE,2),n_nodeno(MAX_IP)
      common /feel_sol/n_sstat(MAX_SOLVE),n_smaxp(MAX_SOLVE)
c ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 8001 read(io_in,9001,end=8900) inp,xx,yy
 9001 format(i8,1PE12.5,1PE12.5)
      if(inp .eq. 0) return
      x(inp) = xx
      y(inp) = yy
      goto 8001
...
c --------------------------------------------------------------------
     ...
     &                 n_ewise(MAX_EWISE,2),n_nodeno(MAX_IP)
      common /feel_sol/n_sstat(MAX_SOLVE),n_smaxp(MAX_SOLVE)
c ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 8001 read(io_in,9001,end=8900) inp,xx,yy,zz
 9001 format(i8,3f10.5)
      if(inp .eq. 0) return
      x(inp) = xx
      y(inp) = yy
      z(inp) = zz
