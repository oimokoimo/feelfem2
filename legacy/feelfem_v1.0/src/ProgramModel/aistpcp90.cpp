...
void PM_aistpcp90::OpenSource(char *filename)
{
...
void PM_aistpcp90::OpenSource(char *filename,int makeFlag)
{
...
void PM_aistpcp90::MODULEzeroclearD(char *varname, char *size)
{
  char buf[BUFSIZ];
...
void PM_aistpcp90::MODULEzeroclearI(char *varname, char *size)
{
  char buf[BUFSIZ];
...
// F90 interface
void PM_aistpcp90::MODULEmallocF90(char *varName,char *varSize)
{
  pushSource("allocate(");
  pushSource(varName);
  pushSource("(");
...
/////////////////////////////////////////////////////////////////
void PM_aistpcp90::pushTypeDefCC(char *s)
{
