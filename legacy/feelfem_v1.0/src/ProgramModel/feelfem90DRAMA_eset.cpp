 ...
 *
 *  Filename : feelfem90DRAMA_eset.cpp
 *  Date     : 2003/02/13 (copied from feelfem90_eset.cpp)
 *  Modified : 
 *  
...
void PM_feelfem90DRAMA::GenerateCoSolveEcalRoutines(SolveElement *sePtr)
{
  GenerateEsetRoutines( sePtr );
  return;
}

void PM_feelfem90DRAMA::pushEsetRoutineName(int solveNo,int solveElementNo,
				       int quadNo                      )
{
  char buf[BUFSIZ];
...
void PM_feelfem90DRAMA::GenerateEsetRoutines(SolveElement *sePtr)
{
...
void PM_feelfem90DRAMA::doEsetCalcInterpolation(SolveElement *sePtr,
...
void PM_feelfem90DRAMA::doEsetCalcInterpolationSub( int quadNo,
					       SolveElement *sePtr,
					       Element *ePtr,
					       int type             )
{
