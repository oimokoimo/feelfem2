 ...
 *
 *  Filename : feelfem90_elem.cpp
 *  Date     : 2000/12/08
 *  Modified : 2001/02/02 orderedPtrList
 *  
 *  Purpose  : elem related routine generator for feelfem90 model
...
string PM_feelfem90::SuperRinjiEcalP2DRAMA(const  char *s)
{
  char  femname[BUFSIZ];
  char  number [BUFSIZ];
  char  val    [BUFSIZ];
...
char *PM_feelfem90::GetElemRoutineName( int solveNo )
{
...
void PM_feelfem90::F90useElemPM(SolveElement *sePtr)
{
...
// ###  Variable definitons
void PM_feelfem90::doElemDeclareArgumentVariablesPM(SolveElement *sePtr)
{
...
void PM_feelfem90::DoElemVariableDefinitionsPM(SolveElement *sePtr)
{
...
void PM_feelfem90::doElemStarters()
{
  SourceStarters();
  return;
}
...
void PM_feelfem90::DoElemParameters(SolveElement *sePtr)
{
...
void PM_feelfem90::DoElemInitializer(SolveElement *sePtr)
{
...
void PM_feelfem90::DoElemElementLoopStart(int flag)
{
  writeSource("do 100 i=1,nelem");         // just this!  ^^;
}


void PM_feelfem90::DoElemCallEcalRoutine(SolveElement *sePtr,int flag)
{
  int strindex(const char *, const char *);
  orderedPtrList <Variable *> varPtrLst = sePtr->GetVariablePtrLst();
  listIterator <Variable *> itr(varPtrLst);
  ...
  pushEcalArgumentLstInElem( sePtr, varPtrLst );   //  feelfem90_ecal.cpp
...
void PM_feelfem90::DoElemElementLoopEnd(int flag)
{
...
void PM_feelfem90::DoElemReturnSequence(SolveElement *sePtr)
{
