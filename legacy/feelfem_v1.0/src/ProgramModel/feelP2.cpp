...
//////////////////////////////////////////////////////////////////
void PM_feelP2::OpenSource(char *filename)
{
...
void PM_feelP2::OpenSource(char *filename, int makeFlag)
{
...
/////////////////////////////////////////////////////////////////
char *PM_feelP2::GetSourceName( char *routineName)
{
...
void PM_feelP2::MODULEzeroclearD(char *varname, char *size)
{
  char buf[BUFSIZ];
...
void PM_feelP2::MODULEzeroclearI(char *varname, char *size)
{
  char buf[BUFSIZ];
...
void PM_feelP2::MODULEmalloc(char *ptr,char *comment,char *size, char *type)
{
  mallocF77(ptr,comment,size,type);
  return;
}

void PM_feelP2::MODULEmallocERT(char *ptr,char *comment,char *size, char *type)
{
...
/////////////////////////////////////////////////////////////////
char *PM_feelP2::GetSolveRoutineName( int no )
{
  char *ptr = new char[8];
  if(no < 10) {
...
//    length++;
//    if(elemNo >99) {
//      cerr <<"elem number too large(GetElemRoutineName)\n";
//      abortExit(1);
//    }
//  }
//
