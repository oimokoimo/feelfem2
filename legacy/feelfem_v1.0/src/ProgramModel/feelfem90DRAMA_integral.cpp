 ...
 *
 *  Filename : feelfem90DRAMA_integral.cpp
 *  Date     : 2003/02/10 (copied from feelfem90_integral.cpp)
 *  
...
void PM_feelfem90DRAMA::DoAssignInitializeIntegral(Assign *asPtr)
{
  comment();
...
void PM_feelfem90DRAMA::DoAssignAssignmentIntegral(Assign *asPtr)
{
...
// CoRoutines
void PM_feelfem90DRAMA::DoAssignCoRoutineHeaderIntegral( Assign *asPtr)
{
  // module sentence
...
void PM_feelfem90DRAMA::DoAssignCoRoutineVariableDefinitionsIntegral( Assign *asPtr)
{
...
void PM_feelfem90DRAMA::DoAssignCoRoutineStatementIntegral( Assign *asPtr)
{
...
void PM_feelfem90DRAMA::doAssignIntegral(Assign *asPtr)
{
...
void PM_feelfem90DRAMA::DoAssignLoopEndIntegral(Assign *asPtr)
{
  writeSource("end do");
  com();
  return;
