...
void PM_feelfem90::OpenSource(char *filename)
{
...
void PM_feelfem90::OpenSource(char *filename,int makeFlag)
{
...
char *PM_feelfem90::GetSourceName( const char *routineName)
{
...
void PM_feelfem90::MODULEzeroclearD(char *varname, char *size)
{
  char buf[BUFSIZ];
...
void PM_feelfem90::MODULEzeroclearI(char *varname, char *size)
{
  char buf[BUFSIZ];
...
// F90 interface
void PM_feelfem90::MODULEmallocF90(char *varName,char *varSize)
{
  pushSource("allocate(");
  pushSource(varName);
  pushSource("(");
