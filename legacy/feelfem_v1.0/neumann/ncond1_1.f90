...
!------------------------------------------------------
   ...
   ba(4,1)=ba(4,1)+(sc_s*qT1_1*qTEST1_1)*ds
   ba(4,2)=ba(4,2)+(qT1_2*sc_s*qTEST1_1)*ds
   ba(4,3)=ba(4,3)+(qT1_3*sc_s*qTEST1_1)*ds
   ba(4,4)=ba(4,4)+(-sc_s*qnx*sc_d*qTEST1_1**2*qx)*ds
   ba(4,5)=ba(4,5)+(-sc_s*qTEST1_2*qnx*sc_d*qTEST1_1*qx)*ds
   ba(4,6)=ba(4,6)+(-sc_s*qTEST1_3*qnx*sc_d*qTEST1_1*qx)*ds

   ba(5,1)=ba(5,1)+(sc_s*qT1_1*qTEST1_2)*ds
   ba(5,2)=ba(5,2)+(qT1_2*sc_s*qTEST1_2)*ds
   ba(5,3)=ba(5,3)+(qT1_3*sc_s*qTEST1_2)*ds
   ba(5,4)=ba(5,4)+(-sc_s*qTEST1_2*qnx*sc_d*qTEST1_1*qx)*ds
   ba(5,5)=ba(5,5)+(-sc_s*qTEST1_2**2*qnx*sc_d*qx)*ds
   ba(5,6)=ba(5,6)+(-sc_s*qTEST1_3*qTEST1_2*qnx*sc_d*qx)*ds

   ba(6,1)=ba(6,1)+(sc_s*qT1_1*qTEST1_3)*ds
   ba(6,2)=ba(6,2)+(qT1_2*sc_s*qTEST1_3)*ds
   ba(6,3)=ba(6,3)+(qT1_3*sc_s*qTEST1_3)*ds
   ba(6,4)=ba(6,4)+(-sc_s*qTEST1_3*qnx*sc_d*qTEST1_1*qx)*ds
   ba(6,5)=ba(6,5)+(-sc_s*qTEST1_3*qTEST1_2*qnx*sc_d*qx)*ds
   ba(6,6)=ba(6,6)+(-sc_s*qTEST1_3**2*qnx*sc_d*qx)*ds
