...
void PM_aistpcp90::DoAssignInitializeIntegral(Assign *asPtr)
{
  comment();
...
void PM_aistpcp90::DoAssignAssignmentIntegral(Assign *asPtr)
{
...
// CoRoutines
void PM_aistpcp90::DoAssignCoRoutineHeaderIntegral( Assign *asPtr)
{
  // module sentence
...
void PM_aistpcp90::DoAssignLoopEndIntegral(Assign *asPtr)
{
  writeSource("end do");
  com();
  return;
...
void PM_aistpcp90::DoAssignCoRoutineVariableDefinitionsIntegral( Assign *asPtr)
{
...
void PM_aistpcp90::DoAssignCoRoutineStatementIntegral( Assign *asPtr)
{
...
void PM_aistpcp90::doAssignIntegral(Assign *asPtr)
{
