...
void PM_feelfem90smpi::DoAssignParametersEwQuad(Assign *asPtr)
{
...
void PM_feelfem90smpi::DoAssignVariableDefinitionsEwQuad(Assign *asPtr)
{
  writeSource("! auto Variable Definitions");


  // variable for ex(NDP), etc. is defined in feelfem90smpi_assign.cpp
...
void PM_feelfem90smpi::DoAssignInitializeEwQuad(Assign *asPtr)
{
  comment();
...
void PM_feelfem90smpi::DoAssignLoopStartEwQuad(Assign *asPtr)
{
  writeSource("do i=1,nelem");
  return;
}

void PM_feelfem90smpi::DoAssignAssignmentEwQuad(Assign *asPtr)
{
  // for x,y,z
...
void PM_feelfem90smpi::DoAssignLoopEndEwQuad(Assign *asPtr)
{
  writeSource("end do");
  com();
  return;
...
// CoRoutines
void PM_feelfem90smpi::DoAssignCoRoutineHeaderEwQuad( Assign *asPtr)
{
  // module sentence
...
void PM_feelfem90smpi::DoAssignCoRoutineVariableDefinitionsEwQuad ( Assign *asPtr)
{
...
void PM_feelfem90smpi::DoAssignCoRoutineStatementEwQuad( Assign *asPtr)
{
...
void PM_feelfem90smpi::doAssignEwiseQuad(Assign *asPtr)
{
