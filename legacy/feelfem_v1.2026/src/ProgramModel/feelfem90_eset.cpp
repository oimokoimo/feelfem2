...
void PM_feelfem90::GenerateCoSolveEcalRoutines(SolveElement *sePtr)
{
  GenerateEsetRoutines( sePtr );
  return;
}

void PM_feelfem90::pushEsetRoutineName(int solveNo,int solveElementNo,
				       int quadNo                      )
{
  char buf[BUFSIZ];
...
void PM_feelfem90::GenerateEsetRoutines(SolveElement *sePtr)
{
...
void PM_feelfem90::doEsetCalcInterpolation(SolveElement *sePtr,
...
void PM_feelfem90::doEsetCalcInterpolationSub( int quadNo,
					       SolveElement *sePtr,
					       Element *ePtr,
					       int type             )
{
