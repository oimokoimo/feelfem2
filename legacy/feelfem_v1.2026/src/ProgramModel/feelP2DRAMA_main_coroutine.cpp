 ...
 *
 *  Filename : feelP2DRAMA_main_coroutine.cpp
 *  Date     : 2002/09/03
 *  Modified : 
 *  
...
void PM_feelP2DRAMA::GenerateMainCoRoutine(Main *mainPtr)
{
...
void PM_feelP2DRAMA::GenerateMaterialVarInitializeRoutine(void)
{
