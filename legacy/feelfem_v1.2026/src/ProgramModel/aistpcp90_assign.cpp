 ...
 *  Date     : 2002/12/10  (Just copy from feelfem90_assign.cpp,
...
// CO-ROUTINE
void PM_aistpcp90::pushAssignCoRoutineName(Assign *asPtr)
{
  pushSource("colet");
  pushSourceInt(asPtr->GetAssignNo());
  return;
...
void PM_aistpcp90::DoAssignCoRoutineReturnSequence(Assign *asPtr)
{
  writeSource("return");
  com();
