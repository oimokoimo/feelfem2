...
void PM_feelfem90vec::OpenSource(char *filename)
{
...
void PM_feelfem90vec::OpenSource(char *filename,int makeFlag)
{
...
char *PM_feelfem90vec::GetSourceName( char *routineName)
{
...
void PM_feelfem90vec::MODULEzeroclearD(char *varname, char *size)
{
  char buf[BUFSIZ];
...
void PM_feelfem90vec::MODULEzeroclearI(char *varname, char *size)
{
  char buf[BUFSIZ];
...
// F90 interface
void PM_feelfem90vec::MODULEmallocF90(char *varName,char *varSize)
{
  pushSource("allocate(");
  pushSource(varName);
  pushSource("(");
