...
C                                                                               
C                                                                               
      SUBROUTINE WEBRMS(A,LA,N,MA,JA,JD,F,U,IDS,IPR,RPR,IW,W,OUT,IERR)          
C----------------------------------------------------------------------         
C                                                                               
C SUBROUTINE NAME : WEBRMS                                                      
C                                                                               
C PURPOSE :                                                                     
C                                                                               
C            THIS SUBROUTINE SOLVES NONSYMMETRIC RANDOM SPARCE LINEAR           
C       SYSTEMS BY THE PRECONDITIONED BI-CONJUGATE GRADIENT (PBCG)              
...
C FORMAT :                                                                      
C                 - -- - -- -- -- -   --- --- ---                               
C     CALL WEBRMS(A,LA,N,MA,JA,JD,F,U,IDS,IPR,RPR,IW,W,OUT,IERR)                
C                                   -     --- ---      --- ----                 
C                                                                               
C ARGUMENTS :                                                                   
C                                                                               
...
C                                      BCG'S ITERATION                          
C                                                                               
      CALL WWRMSB(A,LA,N,MA,JA,JD,F,U,                                          
