...
lib_report()
{
   ...
   F77("      write(io_out,220) np_work_get_falloc(),\n");
   F77("     $                  np_work_get_falloc()*4\n");
   F77("\n");
   ...
   F77(" 130  format('                              FINISH DATE      ',A16)\n");
   F77("*\n");
   F77("      end\n");
   F77("\n");
   F77("\n");
