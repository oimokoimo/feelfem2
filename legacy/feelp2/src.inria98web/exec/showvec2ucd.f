...
*      IWD = 0
      write(*,*) npmax,neelem,3,0,0
      call write_pos(feel(np_x),feel(np_y),npmax)
      call write_ele(feel(np_ielem),nenode,neelem,ID)
      call write_vec(feel(np_u),feel(np_v),npmax)
*
      goto 1000
 9999 continue
      close(11)
...
100   continue
      ...
      do 111 i=1,ne
      write(*,*)i-1,' 1 rect ',ie(1,i),ie(2,i),ie(3,i),ie(4,1)       
111   continue
      endif
      return
      end
      subroutine write_vec(u,v,npmax)
      real*8 u(*),v(*)
      write(*,*) 1,3
      write(*,*) 'vect, m'
      do 100 i=1,npmax
